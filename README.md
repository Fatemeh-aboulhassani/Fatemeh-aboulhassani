...
### M.Sc. Medical Engineering · TU Darmstadt
...
I'm a Medical Engineering graduate student at **TU Darmstadt**, passionate about understanding human movement through data. My work sits at the intersection of biomechanics, signal processing, and computational modeling.

- 🦴 Specializing in **Biomechanics** & **Motion Analysis**
- 📡 Working with **IMU sensors** and **Motion Capture** systems
- 🧠 Applying **Python** to biomedical signal processing pipelines
- 🔬 Using **OpenSim** for musculoskeletal simulation
...
| Area | Tools & Methods |
|------|----------------|
| 🏃 Motion Analysis | Xsens IMU, Motion Capture |
| 🦾 Musculoskeletal Modeling | OpenSim |
| 📊 Signal Processing | Python, MATLAB |
| 🧪 Biomechanics | Kinematic & Kinetic Analysis |
...
![LinkedIn](https://img.shields.io/badge/Let's_connect_on_LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)
